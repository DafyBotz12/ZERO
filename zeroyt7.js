...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6281379753850@s.whatsapp.net`]
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛`, 
                            orderTitle: `𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛`,
...
but = [
          { buttonId: `${prefix}allmenu`, buttonText: { displayText: '𝑫𝒂𝒇𝒚?' }, type: 1 },
          { buttonId: `${prefix}sewabot`, buttonText: { displayText: '♞ 𝑺𝒆𝒘𝒂' }, type: 1 },
          { buttonId: `${prefix}owner`, buttonText: { displayText: '❁ 𝑶𝒘𝒏𝒆𝒓' }, type: 1 }
        ]
...
`
	but = [
{ buttonId: `${prefix}listdiamond`, buttonText: { displayText: '𝑫𝒂𝒊𝒎𝒆𝒏♔︎' }, type: 1 },
{ buttonId: `${prefix}donasi`, buttonText: { displayText: '𝑫𝒐𝒏𝒂𝒔𝒊 𝑳𝒂𝒉 𝑩𝒘𝒂𝒏𝒈' }, type: 1 }
]
...
costum(buffer, sticker, Verived, `𝑩𝒚 𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: '𝑩𝒚 𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: '𝑩𝒚 𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: '𝑩𝒚 𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛'})
break
case 'asupanhijaber':
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: '𝑩𝒚 𝑫𝒂𝒇𝒚𝑽𝒂𝒍𝒍𝑩𝒐𝒕𝒛'})
break
case 'cecanmalaysia':
...
zeroyt7.sendMessage(`6281379753850@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "GOPAY : 081379753850 (𝑫𝒂𝒇𝒚)", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 081379753850 (𝑫𝒂𝒇𝒚)", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 081379753850 (𝑫𝒂𝒇𝒚)", faketeks, but, mek)
break
case 'donasi':
